# Mevcut LLM Entegrasyonları (Available LLM Integrations)

OpenAI, Anthropic, Google, Hugging Face ve daha fazlasıyla entegrasyonları destekliyoruz.
...
-   [Dashscope Çok Modlu (Multi-Modal)](/python/examples/multi_modal/dashscope_multi_modal)
...
-   [Gradient Model Adaptörü (Model Adapter)](/python/examples/llm/gradient_model_adapter)
...
-   [Vercel AI Geçidi (Gateway)](/python/examples/llm/vercel-ai-gateway)
